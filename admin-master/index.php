...
?>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              <span class="info-box-icon bg-info elevation-1"><i class="fa  fa-list" id="icon"></i></span>
...
?>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              <span class="info-box-icon bg-secondary elevation-1"><i class="fa  fa-user-check" id="icon"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">All Supplier </span>
                <span class="info-box-number">
...
?>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              <span class="info-box-icon bg-success elevation-1"><i class="fa fa-users" id="icon"></i></span>
                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-tools">
                      <span class="badge badge-danger"><?php echo $count_drug;  ?> New Medicine </span>
